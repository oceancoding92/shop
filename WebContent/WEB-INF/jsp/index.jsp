...
<!-- 					<div class="hotProductAd">
			<img src="${pageContext.request.contextPath}/image/a.jpg" width="260" height="343" alt="热门商品" title="热门商品">
						...
						<ul class="tabContent" style="display: block;">
								<s:iterator  var="hotproduct" value="hlist">
									<li>
										<a href="${pageContext.request.contextPath}/product_findById.action?pid=<s:property value="#hotproduct.pid"/>"target="_blank"><img src="${pageContext.request.contextPath}/<s:property value="#hotproduct.image"/>" data-original="http://storage.shopxx.net/demo-image/3.0/201301/0ff130db-0a1b-4b8d-a918-ed9016317009-thumbnail.jpg" style="display: block;"></a>
									</li>
								</s:iterator>
						</ul>
...
<!-- 					<div class="newProductAd">
						 ...
						 -->						
						 <ul class="tabContent" style="display: block;">
								<s:iterator  var="newproduct" value="nlist">	
									<li>
										<a href="${pageContext.request.contextPath}/product_findById.action?pid=<s:property value="#newproduct.pid"/> " target="_blank"><img src="${pageContext.request.contextPath}/<s:property value="#newproduct.image" />" data-original="http://storage.shopxx.net/demo-image/3.0/201301/4a51167a-89d5-4710-aca2-7c76edc355b8-thumbnail.jpg" style="display: block;"></a>									</li>
									</li>
								</s:iterator>
						</ul>
						<ul class="tabContent" style="display: none;">
